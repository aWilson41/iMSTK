...
double executionTimestep = 0.005;
    ...
    std::shared_ptr<PbdModel> model)
{
    ...
    tissueObj->setVisualGeometry(colMesh);
...
main()
{
    ...
    *scene->getCamera("debug") = *scene->getActiveCamera();
    ...
    makeCapsules("CapsuleObjs", esophagusCapsuleObjs, pbdModel, 0.003);
...
#pragma endregion
    ...
    //leftGrasping->setGeometryToPick(tissueObj->getPhysicsGeometry(), std::dynamic_pointer_cast<PointwiseMap>(tissueObj->getPhysicsToCollidingMap()));
    ...
    //rightGrasping->setGeometryToPick(tissueObj->getPhysicsGeometry(), std::dynamic_pointer_cast<PointwiseMap>(tissueObj->getPhysicsToCollidingMap()));
