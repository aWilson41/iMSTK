...
double tissueDistStiffness = 20000.0;
...
double executionTimestep = 0.0075;
    ...
    std::shared_ptr<PbdModel> model)
{
    ...
    std::shared_ptr<SurfaceMesh> colMesh = MeshIO::read<SurfaceMesh>(
        "C:/Users/Andx_/Desktop/NewHernia/stomach_surface_collision.obj");
    ...
    tissueObj->setPhysicsToCollidingMap(std::make_shared<PointwiseMap>(tissueMesh, colMesh));
