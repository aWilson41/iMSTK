...
double tetYoungsModulus = 10000.0;
double tetPossionsRatio = 0.40;
    ...
    std::shared_ptr<PbdModel> model)
{
   ...
   /* std::shared_ptr<SurfaceMesh> tissueMesh =
        MeshIO::read<SurfaceMesh>("C:/Users/Andx_/Desktop/NewHernia/volume2/stomach_surface__sf.obj");*/
   ...
   /*model->getConfig()->enableConstraint(PbdModelConfig::ConstraintGenType::Distance, 100000.0,
        tissueObj->getPbdBody()->bodyHandle);
    model->getConfig()->enableConstraint(PbdModelConfig::ConstraintGenType::Volume, 1000.0,
        tissueObj->getPbdBody()->bodyHandle);*/
