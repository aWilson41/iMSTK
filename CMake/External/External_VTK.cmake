...
set(${PROJECT_NAME}_VTK_SOURCE GIT_REPOSITORY https://gitlab.kitware.com/iMSTK/vtk.git)
...
if(${PROJECT_NAME}_VTK_REPO_SOURCE STREQUAL "9.1.202202")
  set(${PROJECT_NAME}_VTK_HASH GIT_TAG 5a9b0a4e2996526944de25895e2e9b750f9e556d) # imstk-v9.1-2022-02-10-5b4df4d9
  list(APPEND VTK_MODULE_SETTINGS
...
if(USE_SYSTEM_VTK)
  set(OpenXR_INCLUDE_DIR ${CMAKE_INSTALL_PREFIX}/include/openxr)
  set(OpenXR_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/openxr_loader.lib)
endif()
