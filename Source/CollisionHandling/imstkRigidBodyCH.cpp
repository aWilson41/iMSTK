    ...
    const std::vector<CollisionElement>& elementsB)
{
    ...
    for (size_t i = 0; i < elementsA.size(); i++)
    {
        ...
        if (elemA.cellType == IMSTK_VERTEX && elemB.cellType == IMSTK_TRIANGLE)
        {
            ...
            if (elemB.idCount == 1)
            {
                tri = (*dynamic_cast<SurfaceMesh*>(geomB.get())->getIndices().get())[elemB.ids[0]];
            }
        ...
        else if (elemA.cellType == IMSTK_EDGE && elemB.cellType == IMSTK_EDGE)
        {
            ...
            if (elemA.idCount == 1)
            {
                edgeA = (*dynamic_cast<LineMesh*>(geomA.get())->getIndices().get())[elemA.ids[0]];
            }
            ...
            if (elemB.idCount == 1)
            {
                edgeB = (*dynamic_cast<LineMesh*>(geomB.get())->getIndices().get())[elemB.ids[0]];
            }
        ...
        else if (elemA.cellType == IMSTK_EDGE && elemB.cellType == IMSTK_VERTEX)
        {
            ...
            if (elemA.idCount == 1)
            {
                edge = (*dynamic_cast<LineMesh*>(geomA.get())->getIndices().get())[elemA.ids[0]];
            }
            else if (elemA.idCount == 2)
            {
        ...
        else if (elemA.cellType == IMSTK_VERTEX && elemB.cellType == IMSTK_EDGE)
        {
            ...
            if (elemB.idCount == 1)
            {
                edge = (*dynamic_cast<LineMesh*>(geomB.get())->getIndices().get())[elemB.ids[0]];
            }
            else if (elemB.idCount == 2)
            {
