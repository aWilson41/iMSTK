...
///
/// \class PbdObjectConstraintController
///
...
///
class PbdObjectConstraintController : public SceneObjectController
{
public:
    PbdObjectConstraintController(const std::string& name = "PbdObjectConstraintController");
    ~PbdObjectConstraintController() override = default;
...
protected:
    ...
    std::shared_ptr<PbdDistanceConstraint> m_distConstraint;
