    ...
    std::vector<CollisionElement>& elementsB)
{
    ...
    std::shared_ptr<VecDataArray<int, 2>>    meshACellsPtr    = lineMesh->getIndices();
    ...
    std::vector<CollisionElement>& elementsB)
{
    ...
    const VecDataArray<double, 3>&           meshAVertices    = *meshAVerticesPtr;
    std::shared_ptr<VecDataArray<int, 3>>    meshACellsPtr    = surfMeshA->getIndices();
